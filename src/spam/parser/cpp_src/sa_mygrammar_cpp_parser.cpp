...
antlr4::tree::ParseTree* get_parse_tree_root(MyGrammarParser *parser) {return parser->root();}

antlr4::tree::ParseTree* get_parse_tree(MyGrammarParser *parser, const char *entry_rule_name) {
    static std::map<std::string, antlr4::tree::ParseTree* (*)(MyGrammarParser*)> table
    {
